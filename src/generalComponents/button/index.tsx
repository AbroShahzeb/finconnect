...
export const Button = ({
  ...
  const varinats = {
    ...
    outlined:
      "hover:bg-neutral-100 text-neutral-600 dark:text-neutral-300 bg-transparent border hover:border-transparent transition-all  border-neutral-300 hover:text-primary-text",
  };
  return (
    <button
